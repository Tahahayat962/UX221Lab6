<?php
if ( ! class_exists( 'Terminal_Blog_Featured_Posts_Widget' ) ) {
	/**
	 * Adds Terminal Blog Featured Posts Widget.
	 */
	class Terminal_Blog_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				...
				'description' => __( 'Retrive Posts List Widgets', 'terminal-blog' ),
			);
			parent::__construct(
				'terminal_blog_featured_posts_widget',
				__( 'Adore Widget: Featured Posts Widget', 'terminal-blog' ),
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'terminal-blog' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'terminal-blog' ); ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">
					<?php
					$categories = terminal_blog_get_post_cat_choices();
