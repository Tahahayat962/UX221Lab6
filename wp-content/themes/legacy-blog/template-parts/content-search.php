...
$archive_category = get_theme_mod( 'terminal_blog_enable_archive_category', true );
$archive_author   = get_theme_mod( 'terminal_blog_enable_archive_author', true );
$archive_date     = get_theme_mod( 'terminal_blog_enable_archive_date', true );
$post_description = get_theme_mod( 'terminal_blog_enable_archive_post_description', true );
?>
	...
	<div class="post-item post-grid">
		...
		<div class="post-item-content">
			...
			<div class="post-content">
				<?php echo wp_kses_post( wp_trim_words( get_the_excerpt(), get_theme_mod( 'terminal_blog_excerpt_length', 20 ) ) ); ?>
			</div><!-- post-content -->
		</div>
	</div>
