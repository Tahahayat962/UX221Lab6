...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary-content"><?php esc_html_e( 'Skip to content', 'legacy-blog' ); ?></a>
			...
			<div class="theme-wrapper">
				<div class="site-header-wrapper <?php echo esc_attr( ! empty( get_header_image() ) ? 'adore-header-image' : '' ); ?>" style="background-image: url('<?php echo esc_url( get_header_image() ); ?>')">
					<div class="adore-top-header">
						<div class="date"><?php echo esc_html( wp_date( 'd, M Y' ) ); ?></div>
					...
					$header_adver_image     = get_theme_mod( 'legacy_blog_advertisement_image', '' );
					$header_adver_image_url = get_theme_mod( 'legacy_blog_advertisement_url', '#' );
					if ( ! empty( $header_adver_image ) ) {
						?>
						<div class="adore-adver-part">
							<a href="<?php echo esc_url( $header_adver_image_url ); ?>">
								<img src="<?php echo esc_url( $header_adver_image ); ?>" alt="<?php echo esc_attr_e( 'Header Advertisement Image', 'legacy-blog' ); ?>">
							</a>
						</div>
						<?php
					}
